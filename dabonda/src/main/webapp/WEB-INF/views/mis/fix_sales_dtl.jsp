...
function go_dtl_sal(p_cd, p_nm) {
	var tmp = '${date}';
	location.href="/fix_sales/dtl/sal?bp_cd=" + p_cd + "&bp_nm=" + p_nm + "&date=" + tmp;
}
</script>
<script>
...
function showDisp() {
	...
	$.ajax({
		//url: 'ajax/test.json',
		url: '/fix_sales/dtl/fix_sales_dtl.json',
		dataType: 'json',
		type : "get",
			...
			$.each(data, function(key, val) {
				...
				for(i = 0; i < val.length; i++) {
					...
					*/
					...
					trHtml = '<tr height="27" style="color:gray" onclick="go_dtl_sal(' + p_cd + ', \'' + p_nm + '\');">';
...
<div class="table">
	<p align="center" style="font-weight:bold; font-size:12pt">
		<font color="#FF4500">월간</font> 확보 매출 (${province_nm} ${date} 상세내역)
	</p>
	<!--
