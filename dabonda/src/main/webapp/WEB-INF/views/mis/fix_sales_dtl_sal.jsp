...
function showDisp() {
	...
	$.ajax({
		url: '/fix_sales/dtl/fix_sales_dtl_sal.json',
		dataType: 'json',
		type : "get",
		data : {bp_cd : bp_cd,
					date : date},
			...
			$.each(data, function(key, val) {
				...
				for(i = 0; i < val.length; i++) {
					...
					*/
					...
					trHtml += '<td align="left">' + val[i].sales_nm + '</td>';
...
<div class="table">
	<p align="center" style="font-weight:bold; font-size:12pt">
		<font color="#FF4500">월간</font> 확보 매출 (${bp_nm} ${date} 상세내역)
	</p>
	<!--
