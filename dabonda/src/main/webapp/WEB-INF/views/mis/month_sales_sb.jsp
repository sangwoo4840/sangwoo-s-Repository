...
function go_dtl(p_cd, p_nm) {
	location.href="/month_sales_sb/dtl?province_cd=" + p_cd + "&province_nm=" + p_nm + "&date=${date}";
}
</script>
<script>
...
function showDisp() {
	...
	$.ajax({
		url: '/month_sales_sb/month_sales_sb.json',
		dataType: 'json',
		type : "get",
		data : {date : date},
...
<div class="table">
	...
	<form name="fm" method="POST" action="/month_sales_sb">
